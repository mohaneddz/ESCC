...
export default function ThankYou() {
    return (
        <div className="center col pb-40 mx-auto gap-2">
            ...
            <div className="center col">
                ...
                <Link href="/" className="mt-2 text-sm md:text-md font-medium text-secondary-dark underline hover:underline">Go back to Home</Link>
            </div>
