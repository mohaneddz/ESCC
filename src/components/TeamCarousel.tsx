  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-1/2 -translate-y-1/2 md:-left-4 left-8 bg-transparent border-none click"
      >
        <Image
      ...
      <button
        ...
        className="absolute top-1/2 -translate-y-1/2 md:-right-4 right-8 bg-transparent border-none click"
      >
        <Image
          src="/svg/misc/arrow.svg"
          alt="Next"
